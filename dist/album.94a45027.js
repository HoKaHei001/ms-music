...
})({"87j00":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7dc900ec94a45027";
"use strict";
...
},{}],"dGSFl":[function(require,module,exports) {
...
(0, _axiosDefault.default).get(`https://monster-siren.hypergryph.com/api/album/${prams.get("id")}/detail`).then((response)=>{
    ...
    cSongs.forEach((element)=>{
        ...
        (0, _axiosDefault.default).get(`https://monster-siren.hypergryph.com/api/song/${element.cid}`).then((response)=>{
            ...
            const li = template.content.cloneNode(true);
            function onloadPlay() {
                if (playerObj.src == "") playerObj.src = playerList[0]["sourceUrl"];
            }
            // onloadPlay();
            // 中身を設定
...
//# sourceMappingURL=album.94a45027.js.map
